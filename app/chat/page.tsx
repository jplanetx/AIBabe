...
// All chat logic is now in ChatPageContent, which is wrapped in Suspense below
function ChatPageContent() {
  const searchParams = useSearchParams();
  // Provide a fallback for girlfriendId if not present
...
// Default export wraps ChatPageContent in Suspense for useSearchParams support
